...
gulp.task('copy-assets', function () {
    gulp.src([ROOT_DIR + '/__assets/**/*.*']).pipe(gulp.dest(ROOT_TARGET_DIR + '/assets'));
});
...
gulp.task('build', gulpSequence('clean', 'copy-assets', 'build-styles', 'build-js', 'inject-resources'));
gulp.task('watch', gulpSequence('clean', 'set-dev-configs', 'copy-assets', 'build-styles', 'watch-handler'));
